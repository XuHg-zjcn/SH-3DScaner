...
public class Camera2BasicFragment extends Activity {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                String str = String.format("mPreviewSize = %d*%d", mPreviewSize.getWidth(), mPreviewSize.getHeight());
                Log.i(TAG, str);
                ...
                mImageReader2 = ImageReader.newInstance(mPreviewSize.getWidth(), mPreviewSize.getHeight(),
                ...
                //showToast("fps: " + Arrays.toString(fpsRanges));
                mCameraId = cameraId;
                return;
            }
    ...
    private void startBackgroundThread() {
        ...
        mBackgroundThread = new HandlerThread("myImageReader");
        mBackgroundThread.start();
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Surface surface2 = mImageReader2.getSurface();
    ...
    private void Image2View_init() {
        ...
        String str = String.format("mTextureView2 = %d*%d", mTextureView2.getWidth(), mTextureView2.getHeight());
        Log.i(TAG, str);
        draw_bmp draw = new draw_bmp();
        thread_draw = new Thread(draw);
        thread_draw.start();
    }
    ...
    class draw_bmp implements Runnable {
        @Override
        public void run() {
    ...
    private class timer_count {
        ...
        String str;
        timer_count(long Log_per_count) {
            start_time = System.currentTimeMillis();
            end_time = start_time;
            last_print_time = start_time;
            this.Log_per_count = Log_per_count;
        }
        public void time_start() {
            start_time = System.currentTimeMillis();
            if(is_running) {
                Log.w(TAG, "time_count: already running");
            }
            is_running = true;
        }
